...
if active_prompt:
    ...
    with chat_box:
        ...
        with st.chat_message("assistant"):
            ...
            # Modell-Kaskade mit offiziell verfügbaren Endpunkten
            ...
            for model_name in MODELS_CASCADE:
                try:
                    ...
                    # Satzende-Prüfung gegen Fragmente
